...
function SpotifyWebApi(credentials) {
    ...
    //Like mentioned, I couln't find a way to get it to call the function above as needed. Thanks for the help! 
    this.getAllMySavedTracks = function (offset, array) {
        ...
        spotifyApi.getMySavedTracks({ limit: 50, offset: offset })
            .then(function (data) {
                ...
                if (data.body.next) {
                    offset += (offset + 50);
                    getAllMySavedTracks(offset, trackArray);
                } else {
                    return trackArray;
                }
            });
